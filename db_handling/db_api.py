...
def get_programs_from_user_id(user_id: str, db_client: pymongo.MongoClient = None) -> list:
...
def submit_workout(exercise_id_to_sets_map: {str: dict}, db_client: pymongo.MongoClient = None):
